...
\begin{abstract}
    ...
    It can be said that humans rely on friendship, not only to prevent the feeling of loneliness, but for the positive mental attributions associated. A common problem however, is planning to socialise with these friends. Being unaware of a friends status or location can often arise challenges that lead to a breakdown in plans. \vskip 0.5em
